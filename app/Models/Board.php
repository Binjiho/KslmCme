...
//        $this->popup_detail = $data['popup_detail'] ?? 'N';
//        $this->popup_link = $data['popup_link'] ?? null;
//        $this->popup_sDate = $data['popup_sDate'] ?? null;
//        $this->popup_eDate = $data['popup_eDate'] ?? null;
