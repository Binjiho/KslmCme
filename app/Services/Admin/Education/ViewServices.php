 ...
 */
class ViewServices extends AppServices
{
    public function indexService(Request $request)
    {
        ...
        if ($request->edu_status) {
            $query->where('edu_status', 'like', "%{$request->edu_status}%");
        }
        ...
        if ($request->excel) {
            ...
            return (new CommonServices())->excelDownload(new ViewExcel($this->data), date('Y-m-d').'_수강기록정보');
        }
