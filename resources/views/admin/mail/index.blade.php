                    ...
                    <div class="table-wrap">
                        <table class="cst-table">
                            ...
                            <tr>
                                <th scope="row">작성일</th>
                                <td class="text-left">
                                    <input type="text" name="create_sdate" value="{{ request()->create_sdate ?? '' }}" class="form-item" readonly datepicker style="width: 46%">
                                    <span>~</span>
                                    <input type="text" name="create_edate" value="{{ request()->create_edate ?? '' }}" class="form-item" readonly datepicker style="width: 46%">
                                </td>

                                <th scope="row">발송일</th>
                                <td class="text-left">
                                    <input type="text" name="send_sdate" value="{{ request()->send_sdate ?? '' }}" class="form-item" readonly datepicker style="width: 46%">
                                    <span>~</span>
                                    <input type="text" name="send_edate" value="{{ request()->send_edate ?? '' }}" class="form-item" readonly datepicker style="width: 46%">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <table class="cst-table list-table">
                    ...
                    @forelse($list as $row)
                        <tr data-sid="{{ $row->sid }}">
                            ...
                            <td>{{ empty($row->send_date) ? '' : $row->send_date->format('Y-m-d') }}</td>
