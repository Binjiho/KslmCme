...
@section('contents')
    ...
    <form id="mail-frm" method="post" action="{{ route('mail.data') }}" data-sid="{{ $mail->sid ?? 0 }}" data-case="mail-{{ empty($mail->sid) ? 'create' : 'update' }}" data-send="N">
        <div class="write-wrap">
            <dl>
                <dt style="text-align: center;">메일제목</dt>
                <dd>
            ...
            <dl>
                <dt style="text-align: center;">보낸사람</dt>
                <dd>
            ...
            <dl>
                ...
                <dd>
                    <input type="text" name="sender_email" id="sender_email" value="{{ $mail->sender_email ?? env('PUBLIC_MAIL') }}" class="form-item">
                </dd>
            </dl>
