                    ...
                    <div class="view-wrap inner-layer">
                        ...
                        <div class="view-conbox">
                            <div class="play-wrap">
                                ...
                                <div id="video_container" class="view-conbox bm10" style="display: none; position: unset; !important;">
                                    <video preload="none" controls="true" autoplay="true" id="video" tabindex="0" width=235 style="border-top:1px solid#dddddd;border-right:1px solid#dddddd;border-left:1px solid#dddddd">
