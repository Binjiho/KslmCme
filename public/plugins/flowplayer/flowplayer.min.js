! function(e) {
    ...
    if (!document.createEvent) {
        var c = !0,
            ...
            m = e.Object,
            h = m.defineProperty || function(e, t, n) {
                e[t] = n.value
            },
            g = m.defineProperties || function(t, n) {
                for (var r in n)
                    if (b.call(n, r)) try {
                        h(t, r, n[r])
                    } catch (o) {
            ...
            y = m.getOwnPropertyDescriptor,
            b = m.prototype.hasOwnProperty,
        ...
        r(e.HTMLCommentElement.prototype, w, "nodeValue"), r(e.HTMLScriptElement.prototype, null, "text"), r(x, null, "nodeValue"), r(e.HTMLTitleElement.prototype, null, "text"), h(e.HTMLStyleElement.prototype, "textContent", function(e) {
            return n(function() {
    ...
    return function t(e, n, r) {
        ...
        1: [function(e, t, n) {
            ...
            var r = t.exports = {},
                ...
                a = e("punycode"),
                l = e("computed-style");
            r.noop = function() {}, r.removeNode = function(e) {
                ...
                var f, d, p, v = e.conf,
                    m = (e.video, window, {
                        ...
                        load: function(r) {
                            ...
                            f = r;
                            var g = i.findDirect("video", t)[0] || i.find(".fp-player > video", t)[0],
                                y = h(r.src),
                                b = /^https?:/.test(y),
                                w = function() {
                                    i.removeNode(g)
                                ...
                                x = function(e) {
                                    return e.some(function(e) {
                                        return !!g.canPlayType(e.type)
                                    })
                                };
                            o.support.video && i.prop(g, "autoplay") && x(r.sources) ? s.one(g, "timeupdate", w) : w();
                            var E = r.rtmp || v.rtmp;
                            if (b || E || (y = i.createAbsoluteUrl(y)), p && c(r) && p.data !== v.swfHls && m.unload(), p) {
                                ["live", "preload", "loop"].forEach(function(e) {
                                    r.hasOwnProperty(e) && p.__set(e, r[e])
                                }), Object.keys(r.flashls || {}).forEach(function(e) {
                                    p.__set("hls_" + e, r.flashls[e])
                                });
                                var k = !1;
                                if (!b && E) p.__set("rtmp", E.url || E);
                                else {
                                    var T = p.__get("rtmp");
                                    k = !!T, p.__set("rtmp", null)
                                }
                                p.__play(y, k || r.rtmp && r.rtmp !== v.rtmp)
                            } else {
                                d = "fpCallback" + ("" + Math.random()).slice(3, 15);
                                var S = {
                                    hostname: v.embedded ? i.hostname(v.hostname) : i.hostname(location.hostname),
                                    url: y,
                                    callback: d
                                };
                                t.getAttribute("data-origin") && (S.origin = t.getAttribute("data-origin")), ["proxy", "key", "autoplay", "preload", "subscribe", "live", "loop", "debug", "splash", "poster", "rtmpt"].forEach(function(e) {
                                    v.hasOwnProperty(e) && (S[e] = v[e]), r.hasOwnProperty(e) && (S[e] = r[e]), (v.rtmp || {}).hasOwnProperty(e) && (S[e] = (v.rtmp || {})[e]), (r.rtmp || {}).hasOwnProperty(e) && (S[e] = (r.rtmp || {})[e])
                                }), v.rtmp && (S.rtmp = v.rtmp.url || v.rtmp), r.rtmp && (S.rtmp = r.rtmp.url || r.rtmp), Object.keys(r.flashls || {}).forEach(function(e) {
                                    var t = r.flashls[e];
                                    S["hls_" + e] = t
                                }), void 0 !== v.bufferTime && (S.bufferTime = v.bufferTime), b && delete S.rtmp, S.rtmp && (S.rtmp = h(S.rtmp));
                                var N, C = i.css(t, "background-color") || "";
                                0 === C.indexOf("rgb") ? N = n(C) : 0 === C.indexOf("#") && (N = u(C)), S.initialVolume = e.volumeLevel;
                                var O = c(r) ? v.swfHls : v.swf;
                                p = a(O, S, v.wmode, N)[0];
                                var j = i.find(".fp-player", t)[0];
                                i.prepend(j, p), setTimeout(function() {
                                    try {
                                        if (!p.PercentLoaded()) return e.trigger("error", [e, {
                                            code: 7,
                                            url: v.swf
                                        }])
                                    } catch (t) {}
                                }, 5e3), setTimeout(function() {
                                    "undefined" == typeof p.PercentLoaded && e.trigger("flashdisabled", [e])
                                }, 1e3), p.pollInterval = setInterval(function() {
                                    if (p) {
                                        var t = p.__status ? p.__status() : null;
                                        t && (e.playing && t.time && t.time !== e.video.time && e.trigger("progress", [e, t.time]), r.buffer = t.buffer / r.bytes * r.duration, e.trigger("buffer", [e, r.buffer]), !r.buffered && t.time > 0 && (r.buffered = !0, e.trigger("buffered", [e])))
                                    }
                                }, 250), window[d] = function(n, r) {
                                    var o = f;
                                    v.debug && console.log("--", n, r);
                                    var i = {
                                        type: n
                                    };
                                    switch (n) {
                                    ...
                                    "click" === n || "keydown" === n ? (i.target = t, s.fire(t, n, [i])) : "buffered" != n && "unload" !== n ? setTimeout(function() {
                                        e.trigger(i, [e, r])
                        ...
                        speed: i.noop,
                        unload: function() {
                            p && p.__unload && p.__unload(), d && window[d] && delete window[d], i.find("object", t).forEach(i.removeNode), p = 0, e.off(".flashengine"), clearInterval(p.pollInterval)
                        }
                    });
                return ["pause", "resume", "seek", "volume"].forEach(function(t) {
                    m[t] = function(n) {
                        try {
                            e.ready && ("seek" == t && e.video.time && !e.paused && e.trigger("beforeseek"), void 0 === n ? p["__" + t]() : p["__" + t](n))
                        } catch (r) {
                            if ("undefined" == typeof p["__" + t]) return e.trigger("flashdisabled", [e]);
                            throw r
                        }
                    }
                }), m
            }, r.engineName = "flash", r.canPlay = function(e, t) {
        ...
        4: [function(e, t, n) {
            ...
            var l, s, u = e("../flowplayer"),
                ...
                h = function(e, t, n, r) {
                    if ("undefined" == typeof t && (t = !0), "undefined" == typeof n && (n = "none"), "undefined" == typeof r && (r = !0), r && l) return l.type = o(e.type), l.src = e.src, l;
            ...
            s = function(e, t) {
                function n(n, o, a) {
                    ...
                    return n.listeners && n.listeners.hasOwnProperty(l) ? void(n.listeners[l] = a) : ((n.listeners || (n.listeners = {}))[l] = a, c.on(o, "error", function(t) {
                        try {
                            i(t.target.getAttribute("type")) && e.trigger("error", {
                                code: 4,
                                video: d(a, {
                                    src: n.src,
                                    url: n.src
                        ...
                        c.off(o)
                    }), void Object.keys(m).forEach(function(o) {
                        var i = m[o];
                        i && t.addEventListener(o, function(s) {
                            if (a = n.listeners[l], s.target && f(s.target).contains("fp-engine") && ("progress" == i && s.srcElement && 0 === s.srcElement.readyState && setTimeout(function() {
                                n.duration || e.conf.live && ("mpegurl" !== e.video.type || !b.hlsDuration) || (i = "error", e.trigger(i, {
                                    code: 4
                                }))
                            }, 1e4), w.debug && !/progress/.test(i) && console.log(o, "->", i, s), (e.ready || /ready|error/.test(i)) && i && p.find("video", t).length)) {
                                var u;
                                ...
                                switch (i) {
                                    case "ready":
                                        ...
                                        try {
                                            u.seekable = !w.live && /mpegurl/i.test(a ? a.type || "" : "") && n.duration || n.seekable && n.seekable.end(null)
                                        } catch (m) {}
                                        ...
                                        }, 250), !w.live && !u.duration && !b.hlsDuration && "loadeddata" === o) {
                                            var h = function() {
                                                u.duration = n.duration;
                                                try {
                                                    u.seekable = n.seekable && n.seekable.end(null)
                                                } catch (e) {}
                                                c(), n.removeEventListener("durationchange", h)
                                            };
                ...
                var o, v, g, y = p.findDirect("video", t)[0] || p.find(".fp-player > video", t)[0],
                    b = u.support,
                ...
                return o = {
                    ...
                    load: function(r) {
                        var o = !1,
                            i = p.find(".fp-player", t)[0],
                            a = !1;
                        w.splash && !y ? (y = h(r), p.prepend(i, y), o = !0) : y ? (f(y).add("fp-engine"), p.find("source,track", y).forEach(p.removeNode), e.conf.nativesubtitles || p.attr(y, "crossorigin", !1), a = y.src === r.src) : (y = h(r, !!r.autoplay || !!w.autoplay, w.clip.preload || "metadata", !1), p.prepend(i, y), o = !0), b.inlineVideo || p.css(y, {
                            position: "absolute",
                            top: "-9999em"
                        }), c.off(y, "timeupdate", p.noop), c.on(y, "timeupdate", p.noop), p.prop(y, "loop", !(!r.loop && !w.loop)), "undefined" != typeof g && (y.volume = g), (e.video.src && r.src != e.video.src || r.index) && p.attr(y, "autoplay", "autoplay"), y.src = r.src, y.type = r.type, n(y, p.find("source", y).concat(y), r), ("none" != w.clip.preload && "mpegurl" != r.type || !b.zeropreload || !b.dataload) && y.load(), (o || a) && y.load(), y.paused && r.autoplay && y.play()
                    },
                    pause: function() {
                        y.pause()
                    },
                    ...
                    unload: function() {
                        p.find("video.fp-engine", t).forEach(p.removeNode), b.cachedVideoTag || (l = null), v = clearInterval(v), y = 0
                    }
                }
        ...
        6: [function(e, t, n) {
            ...
            r(function(e, t) {
                ...
                e.on("progress", function(e, t, n) {
                ...
                }).on("unload", n).on("beforeseek", function() {
                    s = !0
                    ...
                    if (u[o] || (u[o] = []), u[o].push(n), e.cuepoints.push(n), e.conf.generate_cuepoints && n.visible !== !1) {
                        ...
                        i.css(f, "left", c / l * 100 + "%"), s.appendChild(f), a.on(f, "mousedown", function(t) {
                            return t.preventDefault(), e.seek(c), !1
                        })
                    }
                    return e
                ...
                if (e.conf.embed !== !1) {
                    ...
                    n.appendChild(r), n.appendChild(l), e.embedCode = function() {
                        ...
                        if (n.iframe) {
                            ...
                            return '<iframe src="' + e.conf.embed.iframe + '" frameBorder="0" allowfullscreen width="' + o + '" height="' + l + '"></iframe>'
                        }
                        ...
                        var c = 'var w=window,d=document,e;w._fpes||(w._fpes=[],w.addEventListener("load",function(){var s=d.createElement("script");s.src="//embed.flowplayer.org/6.0.2/embed.min.js",d.body.appendChild(s)})),e=[].slice.call(d.getElementsByTagName("script"),-1)[0].parentNode,w._fpes.push({e:e,l:"$library",c:$conf});\n'.replace("$conf", JSON.stringify(u)).replace("$library", n.library || "");
                        ...
                        u.textContent = e.embedCode(), u.focus(), u.select()
                    })
                }
            });
            ...
            t.exports = function(e, t) {
                ...
                e.off = e.unbind = function(r) {
                    ...
                    if (n) {
                        ...
                        return a = n.type || n, l.initEvent(a, !1, !0), r[l.timeStamp + l.type] = o, t.dispatchEvent(l), i ? l : e
                    }
                }
        ...
        9: [function(e, t, n) {
            ...
            i.on(document, "fullscreenchange.ffscr webkitfullscreenchange.ffscr mozfullscreenchange.ffscr MSFullscreenChange.ffscr", function(e) {
                ...
                if (Array.prototype.forEach.call(t.children, function(e) {
                    l.matches(e, ".fp-ratio") || n.appendChild(e)
                }), t.appendChild(n), e.conf.fullscreen) {
                    var o, f, p = window,
                        v = a(t);
                    e.isFullscreen = !1, e.fullscreen = function(t) {
                        return e.disabled ? void 0 : (void 0 === t && (t = !e.isFullscreen), t && (o = p.scrollY, f = p.scrollX), c ? t ? ["requestFullScreen", "webkitRequestFullScreen", "mozRequestFullScreen", "msRequestFullscreen"].forEach(function(e) {
                    ...
                    e.on("mousedown.fs", function() {
                        ...
                        v.add("is-fullscreen"), c || l.css(t, "position", "fixed"), e.isFullscreen = !0
                    }).on(u, function(n) {
                        var r;
                        c || "html5" !== e.engine || (r = t.css("opacity") || "", l.css(t, "opacity", 0)), c || l.css(t, "position", ""), v.remove("is-fullscreen"), c || "html5" !== e.engine || setTimeout(function() {
                            t.css("opacity", r)
            ...
            (r.support.touch || o) && r(function(e, t) {
                ...
                if (n && !o) {
                    ...
                    var v, m = 0,
                        h = function(e) {
                            v = setInterval(function() {
                                e.video.time = ++m, e.trigger("progress", [e, m])
                            }, 1e3)
                        };
                    e.bind("ready pause unload", function() {
                        ...
                        return n.live ? m ? h(n) : void e.one("progress", function(e, t, n) {
                            0 === n && h(t)
                        }) : void 0
                    })
                }
        ...
        12: [function(e, t, n) {
            ...
            r(function(e, t) {
                function n() {
                    return f.test(p.query) ? l.find(p.query) : l.find(p.query, t)
                }

                function r() {
                    return l.find(p.query + "." + v, t)
                }
                ...
                e.play = function(t) {
                    ...
                    return e.conf.playlist = t, delete e.video.index, d(), e
                ...
                }, i.on(t, "click", ".fp-next", e.next), i.on(t, "click", ".fp-prev", e.prev), p.advance && e.off("finish.pl").on("finish.pl", function(e, t) {
                    if (t.video.loop) return t.seek(0, function() {
                        t.resume()
                    });
                    var n = t.video.index >= 0 ? t.video.index + 1 : void 0;
                    n < t.conf.playlist.length || p.loop ? (n = n === t.conf.playlist.length ? 0 : n, m.remove("is-finished"), setTimeout(function() {
                        t.play(n)
                ...
                var h = !1;
                e.conf.playlist.length && (h = !0, d(), e.conf.clip && e.conf.clip.sources.length || (e.conf.clip = e.conf.playlist[0])), n().length && !h && (e.conf.playlist = [], n().forEach(function(t) {
                    var n = t.href;
                ...
                })), i.on(f.test(p.query) ? document : t, "click", p.query, function(t) {
                    t.preventDefault();
                    ...
                    if (e.conf.playlist.length) {
                        var s = r()[0],
                            ...
                            c = i.index = i.index || e.video.index || 0,
                            f = l.find('a[data-index="' + c + '"]', t)[0],
                            d = c == e.conf.playlist.length - 1;
                        s && a(s).remove(v), f && a(f).add(v), m.remove("video" + u), m.add("video" + c), l.toggleClass(t, "last-video", d), i.index = o.video.index = c, i.is_last = o.video.is_last = d
                    }
                }).on("unload.pl", function() {
                    e.conf.playlist.length && (r().forEach(function(e) {
                        a(e).toggle(v)
                    }), e.conf.playlist.forEach(function(e, t) {
                        m.remove("video" + t)
                    }))
        ...
        14: [function(e, t, n) {
            ...
            var r = e("class-list"),
                ...
                l = function(e, t) {
                    var n, l, s, u, c, f, d, p, v = (/iPad/.test(navigator.userAgent) && !/CriOS/.test(navigator.userAgent), i.lastChild(e)),
                        m = r(e),
                        h = r(v),
                        g = !1,
                        y = function() {
                        ...
                        x = function(e, t) {
                            ...
                            return (!d || d >= e) && (h.remove("animated"), g ? h.remove("animated") : (h.add("animated"), i.css(v, "transition-duration", (t || 0) + "ms")), i.css(v, "width", n)), e
                        },
                        E = function(e) {
                    ...
                    return y(), o.on(e, "mousedown.sld touchstart", function(e) {
                        if (e.preventDefault(), !n) {
                            var t = a(b, 100);
                            y(), k.dragging = !0, m.add("is-dragging"), b(w(e)), o.on(document, "mousemove.sld touchmove.sld", function(e) {
                                e.preventDefault(), t(w(e))
                            }), o.one(document, "mouseup touchend", function() {
                                k.dragging = !1, m.remove("is-dragging"), o.off(document, "mousemove.sld touchmove.sld")
                            })
                        }
                    }), k
                };
            ...
            r.defaults.subtitleParser = function(e) {
                ...
                e.on("ready", function(n, i, a) {
                    ...
                    if (r.support.subtitles && l.nativesubtitles && "html5" == i.engine.engineName) {
                        ...
                        return a.subtitles.forEach(function(e) {
        ...
        16: [function(e, t, n) {
            ...
            ! function() {
                ...
                var l = t(),
                    ...
                    m = /Silk/.test(s),
                    h = /IEMobile/.test(s),
                    g = h ? parseFloat(/Windows\ Phone\ (\d+\.\d+)/.exec(s)[1], 10) : 0,
                    y = h ? parseFloat(/IEMobile\/(\d+\.\d+)/.exec(s)[1], 10) : 0,
                    ...
                    w = o(r.support, {
                        ...
                        zeropreload: !u && !p,
                        volume: !(c || p || d || m || f),
                        cachedVideoTag: !(c || d || f || h),
                        firstframe: !(d || c || p || m || f || h || v),
                        inlineVideo: !d && (!h || g >= 8.1 && y >= 11) && (!p || b >= 3),
        ...
        17: [function(e, t, n) {
            ...
            i(function(e, t) {
                ...
                O.disableAnimation(v.contains("is-touch")), e.sliders = e.sliders || {}, e.sliders.timeline = O, e.sliders.volume = A, p.animation || a.html(b, "<p>loading &hellip;</p>"), d.ratio && r(d.ratio);
                try {
                ...
                e.on("ready", function(e, n, i) {
                    ...
                    O.disable(n.disabled || !l), d.adaptiveRatio && !isNaN(i.height / i.width) && r(i.height / i.width, !0), a.html([k, y], o(l)), a.toggleClass(t, "is-long", l >= 3600), A.slide(n.volumeLevel), "flash" === n.engine.engineName ? O.disableAnimation(!0, !0) : O.disableAnimation(!1), a.find(".fp-title", m).forEach(a.removeNode), i.title && a.prepend(m, a.createElement("div", {
                        className: "fp-title"
                    }, i.title))
                }).on("unload", function() {
                    N || w.css("paddingTop", ""), O.slide(0)
                }).on("buffer", function() {
                    var t = e.video,
                        n = t.buffer / t.duration;
                    !t.seekable && p.seekable && O.max(n), 1 > n ? a.css(h, "width", 100 * n + "%") : a.css(h, "width", "100%")
                }).on("speed", function(e, t, n) {
                    x.innerText = n + "x", E.add("fp-hilite"), setTimeout(function() {
                        E.remove("fp-hilite")
                    }, 1e3)
                }).on("buffered", function() {
                    a.css(h, "width", "100%"), O.max(1)
                }).on("progress", function() {
                    var t = e.video.time,
                        n = e.video.duration;
                    O.dragging || O.slide(t / n, e.seeking ? 0 : 250), a.html(g, o(t)), a.html(y, "-" + o(n - t))
                }).on("finish resume seek", function(e) {
                    a.toggleClass(t, "is-finished", "finish" == e.type)
                }).on("stop", function() {
                    a.html(g, o(0)), O.slide(0, 100)
                }).on("finish", function() {
                    a.html(g, o(e.video.duration)), O.slide(1, 100), v.remove("is-seeking")
                    ...
                    if (a.removeClass(t, "is-loading"), a.addClass(t, "is-error"), r) {
                    ...
                    (O.dragging || A.dragging) && (v.add("is-mouseover"), v.remove("is-mouseout"))
                    ...
                    v.add("is-flash-disabled"), e.one("ready", function() {
                ...
                !L || d.splash || d.autoplay || e.on("ready stop", function() {
                    v.add("is-poster"), e.one("progress", function() {
                        v.remove("is-poster")
                    })
        ...
        18: [function(e, t, n) {
            ...
            function r(e, t, n) {
                t && t.embed && (t.embed = o({}, g.defaults.embed, t.embed));
                var r, p, v = e,
                    m = a(v),
                    h = o({}, g.defaults, g.conf, t),
                    w = {},
                    x = new b;
                m.add("is-loading");
                try {
                    w = d ? window.localStorage : w
                } catch (E) {}
                ...
                var T = {
                    conf: h,
                    currentSpeed: 1,
                    volumeLevel: h.muted ? 0 : "undefined" == typeof h.volume ? 1 * w.volume : h.volume,
                    video: {},
                    disabled: !1,
                    finished: !1,
                    loading: !1,
                    muted: "true" == w.muted || h.muted,
                    paused: !1,
                    playing: !1,
                    ready: !1,
                    splash: !1,
                    ...
                    load: function(e, t) {
                        if (!T.error && !T.loading) {
                            T.video = {}, T.finished = !1, e = e || h.clip, e = o({}, x.resolve(e, h.clip.sources)), (T.playing || T.engine) && (e.autoplay = !0);
                            var n = S(e);
                            if (!n) return T.trigger("error", [T, {
                                code: g.support.flashVideo ? 5 : 10
                            }]);
                            if (!n.engineName) throw new Error("engineName property of factory should be exposed");
                            if (T.engine && n.engineName === T.engine.engineName || (T.ready = !1, T.engine && (T.engine.unload(), T.conf.autoplay = !0), p = T.engine = n(T, v), T.one("ready", function() {
                                p.volume(T.volumeLevel)
                            })), o(e, p.pick(e.sources.filter(function(e) {
                                return e.engine ? e.engine === p.engineName : !0
                            }))), e.src) {
                                e.src = s.createElement("a", {
                                    href: e.src
                                }).href;
                                var r = T.trigger("load", [T, e, p], !0);
                                r.defaultPrevented ? T.loading = !1 : (p.load(e), i(e) && (t = e), t && T.one("ready", t))
                            }
                            return T
                        }
                    },
                    pause: function(e) {
                        return !T.ready || T.seeking || T.loading || (p.pause(), T.one("pause", e)), T
                    },
                    resume: function() {
                        return T.ready && T.paused && (p.resume(), T.finished && (T.trigger("resume", [T]), T.finished = !1)), T
                    },
                    toggle: function() {
                    ...
                    seek: function(e, t) {
                        if (T.ready && !T.live) {
                            ...
                            e = r = Math.min(Math.max(e, 0), T.video.duration).toFixed(1);
                            var o = T.trigger("beforeseek", [T, e], !0);
                            o.defaultPrevented ? (T.seeking = !1, s.toggleClass(v, "is-seeking", T.seeking)) : (p.seek(e), i(t) && T.one("seek", t))
                        }
                        return T
                    },
                    seekTo: function(e, t) {
                    ...
                    mute: function(e, t) {
                        return void 0 === e && (e = !T.muted), t || (w.muted = T.muted = e, w.volume = isNaN(w.volume) ? h.volume : w.volume), T.volume(e ? 0 : w.volume, !0), T.trigger("mute", e), T
                    },
                    volume: function(e, t) {
                        return T.ready && (e = Math.min(Math.max(e, 0), 1), t || (w.volume = e), p.volume(e)), T
                    },
                    speed: function(e, t) {
                        return T.ready && ("boolean" == typeof e && (e = h.speeds[h.speeds.indexOf(T.currentSpeed) + (e ? 1 : -1)] || T.currentSpeed), p.speed(e), t && v.one("speed", t)), T
                    },
                    stop: function() {
                    ...
                    unload: function() {
                        return m.contains("is-embedding") || (h.splash ? (T.trigger("unload", [T]), p && p.unload()) : T.stop()), T
                    },
                    shutdown: function() {
                        T.unload(), T.trigger("shutdown", [T]), l.off(v), delete c[v.getAttribute("data-flowplayer-instance-id")]
                    },
                    disable: function(e) {
                        return void 0 === e && (e = !T.disabled), e != T.disabled && (T.disabled = e, T.trigger("disable", e)), T
                    }
                };
                T.conf = o(T.conf, h), u(T);
                var S = function(e) {
                    var t, n = g.engines;
                    if (h.engine) {
                    ...
                    return h.enginePreference && (n = g.engines.filter(function(e) {
                ...
                return v.getAttribute("data-flowplayer-instance-id") || (v.setAttribute("data-flowplayer-instance-id", y++), T.on("boot", function() {
                    (h.splash || m.contains("is-splash") || !g.support.firstframe) && (T.forcedSplash = !h.splash && !m.contains("is-splash"), T.splash = h.autoplay = !0, h.splash || (h.splash = !0), m.add("is-splash")), h.splash && s.find("video", v).forEach(s.removeNode), (h.live || m.contains("is-live")) && (T.live = h.live = !0, m.add("is-live")), f.forEach(function(e) {
                        e(T, v)
                    }), c.push(T), h.splash ? T.unload() : T.load(), h.disabled && T.disable(), T.one("ready", n)
                }).on("load", function(e, t, n) {
                    h.splash && s.find(".flowplayer.is-ready,.flowplayer.is-loading").forEach(function(e) {
                        var t = e.getAttribute("data-flowplayer-instance-id");
                        if (t !== v.getAttribute("data-flowplayer-instance-id")) {
                            var n = c[Number(t)];
                            n && n.conf.splash && n.unload()
                        }
                    }), m.add("is-loading"), t.loading = !0, "undefined" != typeof n.live && (s.toggleClass(v, "is-live", n.live), t.live = n.live)
                }).on("ready", function(e, t, n) {
                    n.time = 0, t.video = n, m.remove("is-loading"), t.loading = !1, t.muted ? t.mute(!0, !0) : t.volume(t.volumeLevel);
                    var r = t.conf.hlsFix && /mpegurl/i.exec(n.type);
                    s.toggleClass(v, "hls-fix", !!r)
                }).on("unload", function(e) {
                    m.remove("is-loading"), T.loading = !1
                    ...
                    t.volumeLevel = Math.round(100 * n) / 100, t.muted ? n && t.mute(!1) : w.volume = n
                    ...
                    T.paused = /pause|finish|unload|stop/.test(e.type), T.paused = T.paused || "ready" === e.type && !h.autoplay && !T.playing, T.playing = !T.paused, s.toggleClass(v, "is-paused", T.paused), s.toggleClass(v, "is-playing", T.playing), T.load.ed || T.pause()
            ...
            l.on(window, "beforeunload", function() {
            ...
            var d = !1;
            try {
                "object" == typeof window.localStorage && (window.localStorage.flowplayerTestStorage = "test", d = !0)
            } catch (p) {}
            var v = /Safari/.exec(navigator.userAgent) && !/Chrome/.exec(navigator.userAgent),
                m = /(\d+\.\d+) Safari/.exec(navigator.userAgent),
                h = m ? Number(m[1]) : 100,
                g = t.exports = function(e, t, n) {
            ...
            o(g, {
                ...
                conf: {},
                set: function(e, t) {
                    "string" == typeof e ? g.conf[e] = t : o(g.conf, e)
                },
                support: {},
                defaults: {
                    debug: d ? !!localStorage.flowplayerDebug : !1,
                    disabled: !1,
                    ...
                    tooltip: !0,
                    mouseoutTimeout: 5e3,
                    volume: d ? "true" == localStorage.muted ? 0 : isNaN(localStorage.volume) ? 1 : localStorage.volume || 1 : 1,
            ...
            if ("undefined" != typeof window.jQuery) {
                var w = window.jQuery;
                w(function() {
                    "function" == typeof w.fn.flowplayer && w('.flowplayer:has(video,script[type="application/json"])').flowplayer()
                });
                var x = function(e) {
                    var t = e.data() || {},
                        n = {};
                    return w.each(["autoplay", "loop", "preload", "poster"], function(r, o) {
                        var i = e.attr(o);
                    ...
                    }).get(), t.sources = (new b).sourcesFromVideoTag(e, w), o(n, {
                        clip: t
                    })
                };
                w.fn.flowplayer = function(e, t) {
                    return this.each(function() {
                        ...
                        var n = w(this),
                            ...
                            a = o.length ? JSON.parse(o.text()) : x(n.find("video")),
                            l = w.extend({}, e || {}, a, n.data()),
                            s = r(this, l, t);
            ...
            e("./ext/support"), e("./engine/embed"), e("./engine/html5"), e("./engine/flash"), e("./ext/ui"), e("./ext/keyboard"), e("./ext/playlist"), e("./ext/cuepoint"), e("./ext/subtitle"), e("./ext/analytics"), e("./ext/embed"), e("./ext/fullscreen"), e("./ext/mobile"), r(function(e, t) {
                ...
                if (f && "function" == typeof key_check && key_check(f, c)) {
                    if (a.logo) {
                        ...
                        a.embed && a.embed.popup && (p.target = "_blank");
                        var v = s("img", {
                            src: a.logo
                        });
                        p.appendChild(v), t.appendChild(p)
                    }
                    ...
                    7 !== h && t.appendChild(m), e.on("pause resume finish unload ready", function(e, n) {
                        ...
                        if (n.video.src) {
                            ...
                            for (var a in o)
                                if (r = n.video.src.indexOf("://" + o[a].reverse().join(".")), -1 !== r) break
                        }
                        if ((4 === r || 5 === r) && l.addClass(t, "no-brand"), /pause|resume/.test(e.type) && "flash" != n.engine.engineName && 4 != r && 5 != r) {
                            ...
                            for (var u in s) s.hasOwnProperty(u) && (p.style[u] = s[u]);
                            n.load.ed = i(p) && (7 === h || m.parentNode == t) && !l.hasClass(t, "no-brand"), n.load.ed || n.pause()
            ...
            ! function(t, r, o) {
                ...
                var n, r = window,
                    ...
                    E = function() {
                        var e = m("altKey attrChange attrName bubbles cancelable ctrlKey currentTarget detail eventPhase getModifierState isTrusted metaKey relatedNode relatedTarget shiftKey srcElement target timeStamp type view which propertyName"),
                            ...
                            o = e.concat(m("char charCode key keyCode keyIdentifier keyLocation location")),
                            i = e.concat(m("data")),
                    ...
                    T = function() {
                        var e = function(e, t, n, r) {
                                var o = function(n, o) {
                                        return t.apply(e, r ? v.call(o, n ? 0 : 1).concat(r) : o)
                                    },
                                    i = function(n, r) {
                            ...
                            t = function(t, n, r, o, i, a, l) {
                                var s, u = x[n];
                                "unload" == n && (r = j(P, t, n, r, o)), u && (u.condition && (r = e(t, r, u.condition, a)), n = u.base || n), this.isNative = s = w[n] && !!t[d], this.customType = !f && !s && n, this.element = t, this.type = n, this.original = o, this.namespaces = i, this.eventType = f || s ? n : "propertychange", this.target = k(t, s), this[d] = !!this.target[d], this.root = l, this.handler = e(t, r, null, a)
                            };
                    ...
                    A = function(e, t) {
                        var r = function(t, r) {
                                for (var o, i = h(e) ? n(e, r) : e; t && t !== r; t = t.parentNode)
                                    for (o = i.length; o--;)
                                        if (i[o] === t) return t
                            },
                            o = function(e) {
                    ...
                    D = function(e, t, n) {
                        ...
                        if (o = u && t.replace(a, ""), o && x[o] && (o = x[o].base), !t || u)(l = u && t.replace(i, "")) && (l = m(l, ".")), P(e, o, n, l);
                    ...
                    M = function(e, t, r, o) {
                        var l, s, u, c, f, h, y; {
                            if (void 0 !== r || "object" != typeof t) {
                                for (g(r) ? (f = v.call(arguments, 3), o = l = r) : (l = o, f = v.call(arguments, 4), o = A(r, l, n)), u = m(t), this === p && (o = j(D, e, t, o, l)), c = u.length; c--;) y = S.put(h = new T(e, u[c].replace(a, ""), o, l, m(u[c].replace(i, ""), "."), f, !1)), h[d] && y && O(e, h.eventType, !0, h.customType);
                                return e
                            }
                    ...
                    L = function(e, t, n, r) {
                        return M.apply(null, h(n) ? [e, n, t, r].concat(arguments.length > 3 ? v.call(arguments, 5) : []) : v.call(arguments))
                    },
                    F = function() {
                    ...
                    I = function(e, t, n) {
                        var r, o, l, s, u, c = m(t);
                        for (r = c.length; r--;)
                            if (t = c[r].replace(a, ""), (s = c[r].replace(i, "")) && (s = m(s, ".")), s || n || !e[d])
                ...
                if (r.attachEvent) {
                    var H = function() {
                        ...
                        r.detachEvent("onunload", H), r.CollectGarbage && r.CollectGarbage()
                    };
                    r.attachEvent("onunload", H)
                }
                return N(), V
            })
        }, {}],
        21: [function(t, n, r) {
            (function(t) {
                ! function(o) {
                    ...
                    function d(e, t, n) {
                        var r = 0;
                        for (e = n ? F(e / C) : e >> 1, e += F(e / t); e > L * S >> 1; r += k) e = F(e / L);
                        return F(r + (L + 1) * e / (e + N))
                    }

                    function p(e) {
                        var t, n, r, o, a, l, s, f, p, v, m = [],
                            h = e.length,
                            g = 0,
                            y = j,
                            b = O;
                        for (n = e.lastIndexOf(P), 0 > n && (n = 0), r = 0; n > r; ++r) e.charCodeAt(r) >= 128 && i("not-basic"), m.push(e.charCodeAt(r));
                        for (o = n > 0 ? n + 1 : 0; h > o;) {
                            for (a = g, l = 1, s = k; o >= h && i("invalid-input"), f = c(e.charCodeAt(o++)), (f >= k || f > F((E - g) / l)) && i("overflow"), g += f * l, p = b >= s ? T : s >= b + S ? S : s - b, !(p > f); s += k) v = k - p, l > F(E / v) && i("overflow"), l *= v;
                            t = m.length + 1, b = d(g - a, t, 0 == a), F(g / t) > E - y && i("overflow"), y += F(g / t), g %= t, m.splice(g++, 0, y)
                        }
                        return u(m)
                    }

                    function v(e) {
                        var t, n, r, o, a, l, u, c, p, v, m, h, g, y, b, w = [];
                        for (e = s(e), h = e.length, t = j, n = 0, a = O, l = 0; h > l; ++l) m = e[l], 128 > m && w.push(I(m));
                        for (r = o = w.length, o && w.push(P); h > r;) {
                            for (u = E, l = 0; h > l; ++l) m = e[l], m >= t && u > m && (u = m);
                            for (g = r + 1, u - t > F((E - n) / g) && i("overflow"), n += (u - t) * g, t = u, l = 0; h > l; ++l)
                                if (m = e[l], t > m && ++n > E && i("overflow"), m == t) {
                                    for (c = n, p = k; v = a >= p ? T : p >= a + S ? S : p - a, !(v > c); p += k) b = c - v, y = k - v, w.push(I(f(v + b % y, 0))), c = F(b / y);
                                    w.push(I(f(c, 0))), a = d(n, g, r == o), n = 0, ++r
                                }++n, ++t
                        }
                        return w.join("")
                    }
                    ...
                    var g = "object" == typeof r && r,
                        y = "object" == typeof n && n && n.exports == g && n,
                        b = "object" == typeof t && t;
        ...
        25: [function(t, n, r) {
            ! function(t, o) {
                ...
                var b, w = RegExp.prototype.exec,
                    ...
                    E = "[object RegExp]";
                b = function(e) {
                    return "object" != typeof e ? !1 : v ? x(e) : d.call(e) === E
                };
                var k, T = String.prototype.valueOf,
                    ...
                    N = "[object String]";
                k = function(e) {
                    return "string" == typeof e ? !0 : "object" != typeof e ? !1 : v ? S(e) : d.call(e) === N
                };
                var C = function(t) {
                        var n = d.call(t),
                    ...
                    P = {
                        ...
                        ToPrimitive: function(t) {
                            ...
                            if (o = t.toString, e(o) && (n = o.call(t), j(n))) return n;
                            throw new TypeError
                        },
                        ToObject: function(e) {
                ...
                var V = !1;
                t.reduce && (V = "object" == typeof t.reduce.call("es5", function(e, t, n, r) {
                    return r
                })), O(t, {
                    reduce: function(t) {
                        var n = P.ToObject(this),
                            r = I && k(this) ? this.split("") : n,
                            o = r.length >>> 0;
                ...
                var U = Array.prototype.indexOf && -1 !== [0, 1].indexOf(1, 2);
                O(t, {
                    indexOf: function(e) {
                        var t = I && k(this) ? this.split("") : P.ToObject(this),
                            n = t.length >>> 0;
                        if (0 === n) return -1;
                        var r = 0;
                ...
                var q = !{
                    ...
                    z = function() {}.propertyIsEnumerable("prototype"),
                    X = !_("x", "0"),
                ...
                (!Date.parse || ne || te || !ee) && (Date = function(e) {
                    var t = function(n, r, o, i, a, l, s) {
                            ...
                            return u = this instanceof e ? 1 === c && String(n) === n ? new e(t.parse(n)) : c >= 7 ? new e(n, r, o, i, a, l, s) : c >= 6 ? new e(n, r, o, i, a, l) : c >= 5 ? new e(n, r, o, i, a) : c >= 4 ? new e(n, r, o, i) : c >= 3 ? new e(n, r, o) : c >= 2 ? new e(n, r) : c >= 1 ? new e(n) : new e : e.apply(this, arguments), O(u, {
                                constructor: t
                            }, !0), u
                        },
                    ...
                    var l = function(t) {
                        ...
                        if (r) {
                            var a, l = Number(r[1]),
                                ...
                                h = Number(r[10] || 0),
                                g = Number(r[11] || 0);
                            return (f > 0 || d > 0 || p > 0 ? 24 : 25) > c && 60 > f && 60 > d && 1e3 > p && s > -1 && 12 > s && 24 > h && 60 > g && u > -1 && u < o(l, s + 1) - o(l, s) && (a = 60 * (24 * (o(l, s) + u) + c + h * m), a = 1e3 * (60 * (a + f + g * m) + d) + p, v && (a = i(a)), a >= -864e13 && 864e13 >= a) ? a : NaN
                        }
                ...
                var re = i.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9. toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
                    oe = {
                        ...
                        pow: function he(e, t, n) {
                            return 0 === t ? n : t % 2 === 1 ? he(e, t - 1, n * e) : he(e * e, t / 2, n)
                        },
                        log: function(e) {
                ...
                var ce = "	\n\f\r   ᠎             　\u2028\u2029\ufeff",
                    ...
                    pe = new RegExp("^" + de + de + "*"),
                    ve = new RegExp(de + de + "*$"),
                    me = o.trim && (ce.trim() || !fe.trim());
                O(o, {
                    trim: function() {
                        if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " + this + " to object");
                        return String(this).replace(pe, "").replace(ve, "")
                    }
                }, me), (8 !== parseInt(ce + "08") || 22 !== parseInt(ce + "0x16")) && (parseInt = function(e) {
                    var t = /^0[xX]/;
                    return function(n, r) {
                        var o = String(n).trim(),
            ...
            ! function(t, r) {
                ...
                function n(i, a, l) {
                    ...
                    return setTimeout(function() {
                        t(i, function e(t, n) {
                            return null === t ? c() : (t = n || -1 !== t.indexOf(".js") || /^https?:\/\//.test(t) || !o ? t : o + t + ".js", m[t] ? (g && (p[g] = 1), 2 == m[t] ? c() : setTimeout(function() {
                                e(t, !0)
                            }, 0)) : (m[t] = 1, g && (p[g] = 1), void r(t, c)))
                        })
                    }, 0), n
                }
                ...
                function r(e, t) {
                    ...
                    r.onload = r.onerror = r[f] = function() {
                        r[c] && !/^c|loade/.test(r[c]) || n || (r.onload = r[f] = null, n = 1, m[e] = 2, t())
